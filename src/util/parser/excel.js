...
var grammar = {
    ...
    {"name": "id", "symbols": [/[_a-zA-Z]/, "id$ebnf$1"], "postprocess": ([fst, snd]) => (console.log(fst, snd), { type: 'identifier',  val: fst + (snd ? snd.join('') : '') })},
    {"name": "number$ebnf$1", "symbols": [/[0-9]/]},
    {"name": "number$ebnf$1", "symbols": ["number$ebnf$1", /[0-9]/], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "number", "symbols": ["number$ebnf$1"], "postprocess": ([fst]) => parseInt(fst.join(('')))},
